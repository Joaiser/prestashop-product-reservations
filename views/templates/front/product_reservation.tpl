...
<form id="reservation_form" class="container mt-4 product-reservation-widget" action="{$url_for_submission}"
  method="POST">
    ...
    <div class="reservation_item mb-3" data-index="0"
      ...
      <div class="mb-3" style="width: 100%;">
        ...
        <select name="product_id[0]" id="product_id_0" class="form-select" required style="width: 100%;">
          ...
          <option value="{$product.id_product}" data-reference="{$product.reference}"
            data-attribute="{$product.id_product_attribute}">
      ...
      <div class="mb-3" style="width: 100%;">
        ...
        <input type="number" id="quantity" name="quantity[0]" class="form-control" min="1" value="1" required
          style="width: 100%;">
      </div>
      <div class="mb-3">
