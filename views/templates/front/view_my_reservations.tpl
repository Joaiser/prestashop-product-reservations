...
<div class="reservas"
  style="display: grid; gap: 40px; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); padding: 50px 0 50px 0;">
  {foreach from=$reservas_por_cliente item=cliente key=id_cliente}
  <div class="cliente"
    style="width: 400px; border: 1px solid #ddd; border-radius: 8px; padding: 20px; margin-bottom: 20px; background-color: #f9f9f9; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
